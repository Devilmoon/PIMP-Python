...
##new PIMP function with two more parameters
## - two.sided checks lower and upper part of the normal distribution
##   and takes the smaller p-value
## - log.p computes the -log10(p-value) directly and more accurate for
##   values close to 0
## - method gives the method for estimation of p-values
##   currently nonparametric "nonpar" and parametric "normal", "lognormal", "gamma" are supported
##   if method is NA, then an optimal choice among the above is used
## - minsize is the minimum number of positive null observations, used for fitting a distribution
